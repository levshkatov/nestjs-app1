...
export interface AppStoreReceiptRequest {
  /** (Required) The Base64-encoded receipt data.*/
  'receipt-data': string;

  /** Your app’s shared secret, which is a hexadecimal string. For more information about the shared secret, see Generate a Receipt Validation Code.*/
  password: string;
...
interface LatestReceiptInfo {
  ...
  offer_code_ref_name?: OfferCodeRefName;
...
type PromotionalOfferId = string;
...
type ReceiptType = 'Production' | 'ProductionVPP' | 'ProductionSandbox' | 'ProductionVPPSandbox';
...
type Status =
  ...
  | 21100 /** Status codes 21100-21199 are various internal data access errors */;
